...
export class MessageService {
  ...
  public msgReaded(user_id: number | null, id_readed: number, readed: number = 1): Observable<any> {
    return this.http.put<number>(environment.SET_READED + user_id + '/' + id_readed, readed);
  }
}
